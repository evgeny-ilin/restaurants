...
public class UserTestData {
    ...
    public static final User USER_NEW = new User(100015, "USER_NEW", "user_new@mail.ru", "1", Role.USER);
    ...
    public static final List<UserTo> USERS_TOS_LIST = new ArrayList<UserTo>(Arrays.asList(asTo(ADMIN), asTo(USER)));
